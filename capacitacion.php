...
// Consultar los datos
$sql = "SELECT fecha, consecutivo, cliente, descripcion, elaboro FROM capacitaciones";
...
$sql_consecutivo = "SELECT MAX(consecutivo) AS max_consecutivo FROM capacitaciones";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO capacitaciones (tipo, fecha, consecutivo, cliente, descripcion, elaboro) VALUES ('C-', ?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="header">
        ...
        <h1>Cotizaciones de Capacitaciones</h1>
    </div>
