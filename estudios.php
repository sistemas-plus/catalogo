...
// Consultar los datos
$sql = "SELECT fecha, consecutivo, cliente, descripcion, elaboro FROM estudios";
...
$sql_consecutivo = "SELECT MAX(consecutivo) AS max_consecutivo FROM estudios";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO estudios (tipo, fecha, consecutivo, cliente, descripcion, elaboro) VALUES ('E-', ?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="header">
        ...
        <h1>Cotizaciones de Estudios</h1>
    </div>
