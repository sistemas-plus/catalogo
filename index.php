...
// Consultar los datos
$sql = "SELECT fecha, consecutivo, cliente, descripcion, elaboro FROM proyectos";
...
$sql_consecutivo = "SELECT MAX(consecutivo) AS max_consecutivo FROM proyectos";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO proyectos (tipo, fecha, consecutivo, cliente, descripcion, elaboro) VALUES ('P-', ?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="header">
        ...
        <h1>Cotizaciones de Proyectos</h1>
    </div>
