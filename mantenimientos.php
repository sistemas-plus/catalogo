...
// Consultar los datos
$sql = "SELECT fecha, consecutivo, cliente, descripcion, elaboro FROM mantenimientos";
...
$sql_consecutivo = "SELECT MAX(consecutivo) AS max_consecutivo FROM mantenimientos";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO mantenimientos (tipo, fecha, consecutivo, cliente, descripcion, elaboro) VALUES ('M-', ?, ?, ?, ?, ?)";
